...
import attachment from "../assets/paperclip.png";
        ...
        <div>
            <div className='online-users-header'>
                ...
                <div style={{ margin: "0 10px", cursor: "pointer" }}>
                    <img onClick={onChatClose} width={10} height={10} src={cancel} alt="close" />
                </div>
            </div>
            ...
            <div>
                {
                    media !== null ? (
                        <div className="attachment-display">
                            ...
                            <span className="remove-attachment">{media.name}</span>
                        </div>
                    ) : null}
                <form onSubmit={sendMessage} className='message-control'>
                    ...
                    <div className='file-input-container'>
                        ...
                        <label htmlFor="hidden-file">
                            <img src={attachment} alt={""} width="30" height="30" />
                        </label>
                    </div>
                    <button>
